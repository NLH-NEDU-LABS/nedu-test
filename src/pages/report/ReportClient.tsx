...
import MbtiResultView from '@/pages/mbti/MbtiResultView';
import EnneagramResultView from '@/pages/enneagram/EnneagramResultView';
...
import type { QuizReportPayload } from './types';
