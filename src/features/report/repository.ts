...
export async function getQuizReport(token: string): Promise<QuizReportPayload | null> {
  ...
  return {
    ...
    persona_label: (metadata.persona_label as string | null) ?? null,
    top_problem_1: (metadata.top_problem_1 as string | null) ?? null,
    top_problem_2: (metadata.top_problem_2 as string | null) ?? null,
    primary_course_name: (metadata.primary_course_name as string | null) ?? null,
    primary_course_url: (metadata.primary_course_url as string | null) ?? null,
    why_fits: (metadata.why_fits as string | null) ?? null,
    maxdiff_scores: (resultJson.scores as unknown[]) ?? [],
    ai_recommendation: resultJson.ai_recommendation ?? metadata.ai_recommendation ?? null,
    mbti_type: (metadata.mbti_type as string | null) ?? null,
    mbti_desc: (metadata.mbti_desc as string | null) ?? null,
    enneagram_type: (metadata.enneagram_type as string | null) ?? null,
    enneagram_desc: (metadata.enneagram_desc as string | null) ?? null,
    has_bazi: !!p.bazi,
